...
import { calculateHealthMetrics } from "@/src/utils/healthCalculations";
...
const Health = () => {
  ...
  const healthMetrics = calculateHealthMetrics({
    ...
    heightCm: setupData.height,
    weightKg: setupData.weight,
    dateOfBirth: setupData.bdate,
    activityLevel: setupData.activeLvl,
  });

  const healthData = {
    bmi: {
      value: healthMetrics.bmi.value,
      category: healthMetrics.bmi.category,
    },
    bmr: healthMetrics.bmr,
    tdee: healthMetrics.tdee,
    idealWeight: healthMetrics.idealWeight,
  ...
  let bmiCategoryTextColor = "text-gray-900";
  if (healthData.bmi.value < 18.5) bmiCategoryTextColor = "text-blue-900";
